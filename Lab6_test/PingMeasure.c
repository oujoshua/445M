...
//  SYSCTL_RCGC2_R |= SYSCTL_RCGC2_GPIOC+SYSCTL_RCGC2_GPIOD;
  ...
  GPIO_PORTD_DEN_R |= 0x50;        // enable digital I/O on PD4,6
	...
	//port D: interrupt 3
  NVIC_PRI0_R = (NVIC_PRI0_R&0x00FFFFFF)|0x80000000; // top 3 bits
...
//ping tester
int ping_main(void){//unsigned long distance; int i; int delay;
...
// 	
	...
	OS_Add_Periodic_Thread(&testInterrupt, 50000, 1);
